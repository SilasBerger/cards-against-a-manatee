...
public class ErrorAlreadyInALobbyEvent extends AbstractClientErrorEvent {

    private NonceId lobbyId;

    public ErrorAlreadyInALobbyEvent() {
    }

    public ErrorAlreadyInALobbyEvent(NonceId lobbyId) {
